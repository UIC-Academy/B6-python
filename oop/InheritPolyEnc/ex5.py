...
v = Vehicle(name="Afrosiyob", brand="Afrosiyob", color="white")

boieng = Plane(name="Boing", brand="Boing", color="white")

f16 = Aircraft(
    name="F16", brand="", color="black", weapon_capacity=10000, target_accuracy=97
)
