...
panasonic = Domashniy(
    name="P345", price=100.00, color="green", brand="Panasonic Inc.", is_wired=True
)
panasonic.call()

nokia3600 = SotkaOld(
    name="Nokia 3660", price=0, color="black", brand="Nokia", fonar="oq"
)
nokia3600.call()

artel = SotkaNew(
    name="Artel V5", price=120.00, color="white", brand="Artel", is_colorful=True
)
artel.listen_music()
...
ipad = Tablet(name="iPad", price=770000.99, brand="Apple", color="silver", size=15.6)
