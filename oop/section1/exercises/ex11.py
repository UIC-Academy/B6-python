...
zafarbeks_card = BankAccount(
    name="Zafarbek", card_number="5614 3467 2134 8765", balance=10000000
)

javohirs_card = BankAccount(
    name="Javohir", card_number="4916 1231 3456 7711", balance=70000000
)
...
# Statefulness - o'zida ma'lum qiymat saqlab turish
